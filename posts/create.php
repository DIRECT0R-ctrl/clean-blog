...
<?php
    ...
    {
        if ($_POST['title'] == '' OR $_POST['subtitle'] == '' OR $_POST['body'] == '' OR $_POST['image'] == '')
        {
            ...
            $insert = $connection->prepare("INSERT INTO posts (
                title, subtitle, body, image, user_id
            )
            ...
            if (move_uploaded_file($_FILE['image']['tmp_name'], $dir)) {
